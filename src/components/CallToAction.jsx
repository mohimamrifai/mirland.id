    ...
    return (
        <section className="bg-indigo-600 py-16 text-white text-center">
            <div className="container mx-auto">
                ...
                <button className="bg-orange-400 text-gray-900 px-6 py-3 rounded-full hover:bg-white font-medium transition-all duration-200">Dapatkan Penawaran Sekarang</button>
            </div>
        </section>
    );
};
